    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
      ...
      <li class="nav-item">
        ...
        <div id="employee" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item" href="employees.jsp"><i class="fas fa-fw fa-table"></i>&nbsp;&nbsp;List</a>
            <a class="collapse-item" href="addEmployee.jsp"><i class="fas fa-user fa-fw "></i>&nbsp;&nbsp;Add</a>
          </div>
        </div>
      </li>
      ...
      <li class="nav-item">
        ...
        <div id="assignment" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
          <div class="bg-white py-2 collapse-inner rounded">
            <h6 class="collapse-header">Completed :</h6>
            <a class="collapse-item" href="setHtmlModelTmp.jsp"><i class="fas fa-fw fa-file-code"></i>&nbsp;&nbsp;setHtmlModel</a>
            <a class="collapse-item" href="assignment.jsp"><i class="fas fa-fw fa-file-code"></i>&nbsp;&nbsp;setTRLoopModel(using tm-for)</a>
          </div>
        </div>
      </li>
          ...
          <ul class="navbar-nav ml-auto">
            ...
            <li class="nav-item dropdown no-arrow">
              <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                <span id="userProfileName" class="mr-2 d-none d-lg-inline text-gray-600 small">null</span>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            <span>&copy; Soni Enterprises 2020-2022</span>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
